...
## 프로젝트 개요
- **기획의도**: 수기로 진행되던 출결을 **간단한 인증**으로 처리하여 행정 업무를 줄이고, 강·학생 모두의 편의성을 높이며 수업 시간을 확보하기 위함. :contentReference[oaicite:0]{index=0}  
- **프로젝트 목적**: 웹 개발 역량(JAVA/HTML/DB)을 키우고 **MVC 패턴 이해도**를 높이기 위함. :contentReference[oaicite:1]{index=1}
...
---
## 프로젝트 일정계획
- `~ 24.10.14(월)`: **주제 제안서 작성 완료**  
- `~ 24.10.17(목)`: **요구 분석서 작성 완료**  
- `~ 24.10.22(화)`: **유즈다이어그램·프로젝트 설계서 작성**  
- `~ 24.10.25(금)`: **HTML 프로토타입/화면설계서 작성 완료**  
- `~ 24.11.06(수)`: **모든 페이지 기능 구현 완료**  
- `~ 24.11.08(금)`: **검수 및 보완 수정**  
- `~ 24.11.11(월)`: **배포 및 검수**  
- `~ 24.11.13(목)`: **최종 발표 및 피드백**
